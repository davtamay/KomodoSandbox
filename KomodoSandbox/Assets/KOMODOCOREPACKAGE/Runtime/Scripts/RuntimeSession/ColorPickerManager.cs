...
namespace Komodo.IMPRESS
{
    public static class ColorPickerManager
    {
        ...
        */
        ...
        private static bool isSelectingColor;
        ...
        public static void AssignComponentReferences (List<LineRenderer> _lineRenderers, List<TriggerDraw> _triggers, GameObject _colorImageObject, GameObject _selectedColorCursor, GameObject _previewColorCursor, Image _selectedColorDisplay, Image _previewColorDisplay)
        {
        ...
        public static void UpdateColors()
        {
            if (_isPreviewing)
            {
                ...
                previewColor = GetPixelFromNormalizedPosition(colorTexture, previewColorCursorNormalizedPosition);

                DisplayColor(previewColorDisplay, previewColor);
                
              //  Debug.Log("is previewing : " + previewColor + " " + previewColorCursorNormalizedPosition );
            }
            ...
            if (isSelectingColor)
            {
               ...
               // Debug.Log("is dragging");
                ...
                selectedColorCursor.transform.localPosition = previewColorCursor.transform.localPosition;//new Vector3(previewColorCursor.transform.localPosition.x, 0, previewColorCursor.transform.localPosition.y);
                
                
                DisplayColor(selectedColorDisplay, previewColor);

                SetLineRenderersColor(lineRenderers, previewColor);
        ...
        public static void SetIsSelectingColor (bool value)
        {
            foreach (var item in triggers)
            {
                ...
                Debug.Log("SELECTION COLOR LR :  " + value);
                item.enabled = !value;
            }
        }
